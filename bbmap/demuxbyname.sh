...
echo "
   ...
   ****************************   IMPORTANT   ****************************   
This is deprecated and replaced by demuxbyname2.sh, which supports unlimited
output files.  This version will run out of file handles if hundreds or
thousands of output files are needed.  demuxbyname.sh still works, though,
