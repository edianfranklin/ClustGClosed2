...
open (OUT, ">> $out_stat_file");
    ...
    print OUT "<< Subcontig assembly integrity >>\n\n";
    print OUT "Number of subcontigs: $total_query_num\n";
    print OUT "Total number of misassembled subcontigs = $misassemble_query_num ($rate_misassemble_query%)\n";
    print OUT "Total number of truely assembled subcontigs = $truely_assemble_query_num ($rate_truely_assemble_query%)\n";
    print OUT "Total number of misassembled events = $total_misassemble_num\n";
    print OUT "Number of unmapped subcontigs = $unmapped_query_num ($rate_unmapped_query%)\n\n";
    ...
    print OUT "Total subcontig length: $total_len\n";
    print OUT "Subcontig N50: $N50\n";
    print OUT "Corrected subcontig N50: $corrected_N50\n";
close (OUT);

print STDERR "<< Subcontig assembly integrity >>\n";
print STDERR "Total number of subcontigs = $total_query_num\n";
print STDERR "Total number of misassembled subcontigs = $misassemble_query_num ($rate_misassemble_query%)\n";
print STDERR "Total number of misassembled events = $total_misassemble_num\n";
print STDERR "Number of unmapped subcontigs = $unmapped_query_num ($rate_unmapped_query%)\n";
print STDERR "Subcontig N50: $N50\tCorrected subcontig N50: $corrected_N50\n";
